...
Years later, after moving through a couple of organizations, I made the deliberate decision to step away from formal employment to remove the boundaries that were limiting my technical breadth. I chose to work independently so I could take on projects that demanded deeper architectural thinking and fluency across multiple languages. I began with the obvious choice: building the oscilloscope I never bought. What followed were hard lessons in embedded constraints, C++, and UI architecture.